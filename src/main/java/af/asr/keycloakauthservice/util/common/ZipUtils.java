...
import af.asr.keycloakauthservice.util.common.constant.ZipUtilConstants;
...
public class ZipUtils {
	...
	public static byte[] unzipByteArray(byte[] input) throws IOException {
		...
		try (ByteArrayOutputStream oZipStream = new ByteArrayOutputStream()) {
			...
			throw new af.asr.keycloakauthservice.exception.common.DataFormatException(ZipUtilConstants.DATA_FORMATE_ERROR_CODE.getErrorCode(),
